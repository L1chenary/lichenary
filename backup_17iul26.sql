...
\restrict sRnBZ1aQNXDl6NBweT6PLK1c5105CYfX3R6Bd6YIMpk39a82V28O2lkcRxcbVew
...
--
-- Name: auth; Type: SCHEMA; Schema: -; Owner: lichenary_db_pciw_user
--

CREATE SCHEMA auth;


ALTER SCHEMA auth OWNER TO lichenary_db_pciw_user;

--
-- Name: extensions; Type: SCHEMA; Schema: -; Owner: lichenary_db_pciw_user
--

CREATE SCHEMA extensions;


ALTER SCHEMA extensions OWNER TO lichenary_db_pciw_user;

--
-- Name: graphql; Type: SCHEMA; Schema: -; Owner: lichenary_db_pciw_user
--

CREATE SCHEMA graphql;


ALTER SCHEMA graphql OWNER TO lichenary_db_pciw_user;

--
-- Name: graphql_public; Type: SCHEMA; Schema: -; Owner: lichenary_db_pciw_user
--

CREATE SCHEMA graphql_public;


ALTER SCHEMA graphql_public OWNER TO lichenary_db_pciw_user;

--
-- Name: pgbouncer; Type: SCHEMA; Schema: -; Owner: lichenary_db_pciw_user
--

CREATE SCHEMA pgbouncer;


ALTER SCHEMA pgbouncer OWNER TO lichenary_db_pciw_user;

--
-- Name: public; Type: SCHEMA; Schema: -; Owner: lichenary_db_pciw_user
--

-- *not* creating schema, since initdb creates it


ALTER SCHEMA public OWNER TO lichenary_db_pciw_user;

--
-- Name: realtime; Type: SCHEMA; Schema: -; Owner: lichenary_db_pciw_user
--

CREATE SCHEMA realtime;


ALTER SCHEMA realtime OWNER TO lichenary_db_pciw_user;

--
-- Name: storage; Type: SCHEMA; Schema: -; Owner: lichenary_db_pciw_user
--

CREATE SCHEMA storage;


ALTER SCHEMA storage OWNER TO lichenary_db_pciw_user;

--
-- Name: vault; Type: SCHEMA; Schema: -; Owner: lichenary_db_pciw_user
--

CREATE SCHEMA vault;


ALTER SCHEMA vault OWNER TO lichenary_db_pciw_user;
...
--
-- Name: aal_level; Type: TYPE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TYPE auth.aal_level OWNER TO lichenary_db_pciw_user;

--
-- Name: code_challenge_method; Type: TYPE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TYPE auth.code_challenge_method OWNER TO lichenary_db_pciw_user;

--
-- Name: factor_status; Type: TYPE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TYPE auth.factor_status OWNER TO lichenary_db_pciw_user;

--
-- Name: factor_type; Type: TYPE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TYPE auth.factor_type OWNER TO lichenary_db_pciw_user;

--
-- Name: oauth_registration_type; Type: TYPE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TYPE auth.oauth_registration_type OWNER TO lichenary_db_pciw_user;

--
-- Name: one_time_token_type; Type: TYPE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TYPE auth.one_time_token_type OWNER TO lichenary_db_pciw_user;

--
-- Name: action; Type: TYPE; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER TYPE realtime.action OWNER TO lichenary_db_pciw_user;

--
-- Name: equality_op; Type: TYPE; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER TYPE realtime.equality_op OWNER TO lichenary_db_pciw_user;

--
-- Name: user_defined_filter; Type: TYPE; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER TYPE realtime.user_defined_filter OWNER TO lichenary_db_pciw_user;

--
-- Name: wal_column; Type: TYPE; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER TYPE realtime.wal_column OWNER TO lichenary_db_pciw_user;

--
-- Name: wal_rls; Type: TYPE; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER TYPE realtime.wal_rls OWNER TO lichenary_db_pciw_user;

--
-- Name: email(); Type: FUNCTION; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION auth.email() OWNER TO lichenary_db_pciw_user;

--
-- Name: FUNCTION email(); Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: jwt(); Type: FUNCTION; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION auth.jwt() OWNER TO lichenary_db_pciw_user;

--
-- Name: role(); Type: FUNCTION; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION auth.role() OWNER TO lichenary_db_pciw_user;

--
-- Name: FUNCTION role(); Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: uid(); Type: FUNCTION; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION auth.uid() OWNER TO lichenary_db_pciw_user;

--
-- Name: FUNCTION uid(); Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: grant_pg_cron_access(); Type: FUNCTION; Schema: extensions; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION extensions.grant_pg_cron_access() OWNER TO lichenary_db_pciw_user;

--
-- Name: FUNCTION grant_pg_cron_access(); Type: COMMENT; Schema: extensions; Owner: lichenary_db_pciw_user
--
...
--
-- Name: grant_pg_graphql_access(); Type: FUNCTION; Schema: extensions; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION extensions.grant_pg_graphql_access() OWNER TO lichenary_db_pciw_user;

--
-- Name: FUNCTION grant_pg_graphql_access(); Type: COMMENT; Schema: extensions; Owner: lichenary_db_pciw_user
--
...
--
-- Name: grant_pg_net_access(); Type: FUNCTION; Schema: extensions; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION extensions.grant_pg_net_access() OWNER TO lichenary_db_pciw_user;

--
-- Name: FUNCTION grant_pg_net_access(); Type: COMMENT; Schema: extensions; Owner: lichenary_db_pciw_user
--
...
--
-- Name: pgrst_ddl_watch(); Type: FUNCTION; Schema: extensions; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION extensions.pgrst_ddl_watch() OWNER TO lichenary_db_pciw_user;

--
-- Name: pgrst_drop_watch(); Type: FUNCTION; Schema: extensions; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION extensions.pgrst_drop_watch() OWNER TO lichenary_db_pciw_user;

--
-- Name: set_graphql_placeholder(); Type: FUNCTION; Schema: extensions; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION extensions.set_graphql_placeholder() OWNER TO lichenary_db_pciw_user;

--
-- Name: FUNCTION set_graphql_placeholder(); Type: COMMENT; Schema: extensions; Owner: lichenary_db_pciw_user
--
...
--
-- Name: get_auth(text); Type: FUNCTION; Schema: pgbouncer; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION pgbouncer.get_auth(p_usename text) OWNER TO lichenary_db_pciw_user;

--
-- Name: apply_rls(jsonb, integer); Type: FUNCTION; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION realtime.apply_rls(wal jsonb, max_record_bytes integer) OWNER TO lichenary_db_pciw_user;

--
-- Name: broadcast_changes(text, text, text, text, text, record, record, text); Type: FUNCTION; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION realtime.broadcast_changes(topic_name text, event_name text, operation text, table_name text, table_schema text, new record, old record, level text) OWNER TO lichenary_db_pciw_user;

--
-- Name: build_prepared_statement_sql(text, regclass, realtime.wal_column[]); Type: FUNCTION; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION realtime.build_prepared_statement_sql(prepared_statement_name text, entity regclass, columns realtime.wal_column[]) OWNER TO lichenary_db_pciw_user;

--
-- Name: cast(text, regtype); Type: FUNCTION; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION realtime."cast"(val text, type_ regtype) OWNER TO lichenary_db_pciw_user;

--
-- Name: check_equality_op(realtime.equality_op, regtype, text, text); Type: FUNCTION; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION realtime.check_equality_op(op realtime.equality_op, type_ regtype, val_1 text, val_2 text) OWNER TO lichenary_db_pciw_user;

--
-- Name: is_visible_through_filters(realtime.wal_column[], realtime.user_defined_filter[]); Type: FUNCTION; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION realtime.is_visible_through_filters(columns realtime.wal_column[], filters realtime.user_defined_filter[]) OWNER TO lichenary_db_pciw_user;

--
-- Name: quote_wal2json(regclass); Type: FUNCTION; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION realtime.quote_wal2json(entity regclass) OWNER TO lichenary_db_pciw_user;

--
-- Name: send(jsonb, text, text, boolean); Type: FUNCTION; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION realtime.send(payload jsonb, event text, topic text, private boolean) OWNER TO lichenary_db_pciw_user;

--
-- Name: subscription_check_filters(); Type: FUNCTION; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION realtime.subscription_check_filters() OWNER TO lichenary_db_pciw_user;

--
-- Name: to_regrole(text); Type: FUNCTION; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION realtime.to_regrole(role_name text) OWNER TO lichenary_db_pciw_user;

--
-- Name: topic(); Type: FUNCTION; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION realtime.topic() OWNER TO lichenary_db_pciw_user;

--
-- Name: can_insert_object(text, text, uuid, jsonb); Type: FUNCTION; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION storage.can_insert_object(bucketid text, name text, owner uuid, metadata jsonb) OWNER TO lichenary_db_pciw_user;

--
-- Name: extension(text); Type: FUNCTION; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION storage.extension(name text) OWNER TO lichenary_db_pciw_user;

--
-- Name: filename(text); Type: FUNCTION; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION storage.filename(name text) OWNER TO lichenary_db_pciw_user;

--
-- Name: foldername(text); Type: FUNCTION; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION storage.foldername(name text) OWNER TO lichenary_db_pciw_user;

--
-- Name: get_size_by_bucket(); Type: FUNCTION; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION storage.get_size_by_bucket() OWNER TO lichenary_db_pciw_user;

--
-- Name: list_multipart_uploads_with_delimiter(text, text, text, integer, text, text); Type: FUNCTION; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION storage.list_multipart_uploads_with_delimiter(bucket_id text, prefix_param text, delimiter_param text, max_keys integer, next_key_token text, next_upload_token text) OWNER TO lichenary_db_pciw_user;

--
-- Name: list_objects_with_delimiter(text, text, text, integer, text, text); Type: FUNCTION; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION storage.list_objects_with_delimiter(bucket_id text, prefix_param text, delimiter_param text, max_keys integer, start_after text, next_token text) OWNER TO lichenary_db_pciw_user;

--
-- Name: operation(); Type: FUNCTION; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION storage.operation() OWNER TO lichenary_db_pciw_user;

--
-- Name: search(text, text, integer, integer, integer, text, text, text); Type: FUNCTION; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION storage.search(prefix text, bucketname text, limits integer, levels integer, offsets integer, search text, sortcolumn text, sortorder text) OWNER TO lichenary_db_pciw_user;

--
-- Name: update_updated_at_column(); Type: FUNCTION; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER FUNCTION storage.update_updated_at_column() OWNER TO lichenary_db_pciw_user;
...
--
-- Name: audit_log_entries; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.audit_log_entries OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE audit_log_entries; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: flow_state; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.flow_state OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE flow_state; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: identities; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.identities OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE identities; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: COLUMN identities.email; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: instances; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.instances OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE instances; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_amr_claims; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.mfa_amr_claims OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE mfa_amr_claims; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_challenges; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.mfa_challenges OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE mfa_challenges; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_factors; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.mfa_factors OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE mfa_factors; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: oauth_clients; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.oauth_clients OWNER TO lichenary_db_pciw_user;

--
-- Name: one_time_tokens; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.one_time_tokens OWNER TO lichenary_db_pciw_user;

--
-- Name: refresh_tokens; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.refresh_tokens OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE refresh_tokens; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: refresh_tokens_id_seq; Type: SEQUENCE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER SEQUENCE auth.refresh_tokens_id_seq OWNER TO lichenary_db_pciw_user;

--
-- Name: refresh_tokens_id_seq; Type: SEQUENCE OWNED BY; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: saml_providers; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.saml_providers OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE saml_providers; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: saml_relay_states; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.saml_relay_states OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE saml_relay_states; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: schema_migrations; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.schema_migrations OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE schema_migrations; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sessions; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.sessions OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE sessions; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: COLUMN sessions.not_after; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sso_domains; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.sso_domains OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE sso_domains; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sso_providers; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.sso_providers OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE sso_providers; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: COLUMN sso_providers.resource_id; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: users; Type: TABLE; Schema: auth; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE auth.users OWNER TO lichenary_db_pciw_user;

--
-- Name: TABLE users; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: COLUMN users.is_sso_user; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: observation; Type: TABLE; Schema: public; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE public.observation OWNER TO lichenary_db_pciw_user;

--
-- Name: observation_id_seq; Type: SEQUENCE; Schema: public; Owner: lichenary_db_pciw_user
--
...
ALTER SEQUENCE public.observation_id_seq OWNER TO lichenary_db_pciw_user;

--
-- Name: observation_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lichenary_db_pciw_user
--
...
--
-- Name: user; Type: TABLE; Schema: public; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE public."user" OWNER TO lichenary_db_pciw_user;

--
-- Name: user_id_seq; Type: SEQUENCE; Schema: public; Owner: lichenary_db_pciw_user
--
...
ALTER SEQUENCE public.user_id_seq OWNER TO lichenary_db_pciw_user;

--
-- Name: user_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: lichenary_db_pciw_user
--
...
--
-- Name: messages; Type: TABLE; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE realtime.messages OWNER TO lichenary_db_pciw_user;

--
-- Name: schema_migrations; Type: TABLE; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE realtime.schema_migrations OWNER TO lichenary_db_pciw_user;

--
-- Name: subscription; Type: TABLE; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE realtime.subscription OWNER TO lichenary_db_pciw_user;

--
-- Name: subscription_id_seq; Type: SEQUENCE; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
--
-- Name: buckets; Type: TABLE; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE storage.buckets OWNER TO lichenary_db_pciw_user;

--
-- Name: COLUMN buckets.owner; Type: COMMENT; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: migrations; Type: TABLE; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE storage.migrations OWNER TO lichenary_db_pciw_user;

--
-- Name: objects; Type: TABLE; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE storage.objects OWNER TO lichenary_db_pciw_user;

--
-- Name: COLUMN objects.owner; Type: COMMENT; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: s3_multipart_uploads; Type: TABLE; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE storage.s3_multipart_uploads OWNER TO lichenary_db_pciw_user;

--
-- Name: s3_multipart_uploads_parts; Type: TABLE; Schema: storage; Owner: lichenary_db_pciw_user
--
...
ALTER TABLE storage.s3_multipart_uploads_parts OWNER TO lichenary_db_pciw_user;

--
-- Name: refresh_tokens id; Type: DEFAULT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: observation id; Type: DEFAULT; Schema: public; Owner: lichenary_db_pciw_user
--
...
--
-- Name: user id; Type: DEFAULT; Schema: public; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: audit_log_entries; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: flow_state; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: identities; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: instances; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: mfa_amr_claims; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: mfa_challenges; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: mfa_factors; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: oauth_clients; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: one_time_tokens; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: refresh_tokens; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: saml_providers; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: saml_relay_states; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: schema_migrations; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: sessions; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: sso_domains; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: sso_providers; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: observation; Type: TABLE DATA; Schema: public; Owner: lichenary_db_pciw_user
--
...
786	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761982823/uv0frnb8dz9y57mkfyw8.jpg	2025-10-28 10:39:00	Virgin Mary’s House, Izmir Province, Türkiye	37.91163	27.33394	\N	\N	f	2
...
787	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761982899/wo2yzentxgkjj3g36yhs.jpg	2025-10-28 10:40:00	Virgin Mary’s House, Izmir Province, Türkiye	37.91153	27.33408	\N	\N	f	2
788	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761982966/oeu2gt2nwailctwzpwdd.jpg	2025-10-28 10:42:00	Virgin Mary’s House, Izmir Province, Türkiye	37.91156	27.33394	\N	\N	f	2
...
790	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761983076/gooqrvauqvb4pxcmehwe.jpg	2025-10-28 10:43:00	Virgin Mary’s House, Izmir Province, Türkiye	37.91143	27.33411	\N	\N	f	2
...
796	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761984226/iwpk9glrkmla6c2fxc5w.jpg	2025-10-29 11:01:00	Menemen, Seyrek, İzmir Province, Türkiye	38.53256	26.89732	\N	\N	f	2
...
797	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761984321/xkmqozrmgcepzhdknqv9.jpg	2025-10-29 11:04:00	Menemen, Seyrek, İzmir Province, Türkiye	38.53366	26.89783	\N	\N	f	2
...
799	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761984472/puv2oeuolfsgb64rmdh4.jpg	2025-10-29 11:07:00	Menemen, Seyrek, İzmir Province, Türkiye	38.5322	26.89442	\N	\N	f	2
802	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761984789/q14zu9pozkm7tffabvop.jpg	2025-10-29 11:12:00	İzmir Dogal Yașam Parki, Zoo, Türkiye	38.49061	26.95935	\N	\N	f	2
803	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761984845/v7r3b9buhpgwvc9c3yxm.jpg	2025-10-29 11:13:00	İzmir Dogal Yașam Parki, Zoo, Türkiye	38.49052	26.96128	\N	\N	f	2
804	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761984943/x3en9qqga4tc6vvfnxya.jpg	2025-10-29 11:14:00	İzmir Dogal Yașam Parki, Zoo, Türkiye	38.49139	26.96293	\N	\N	f	2
805	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761984989/tafttj3ijwl03fu6wkqx.jpg	2025-10-29 11:15:00	İzmir Dogal Yașam Parki, Zoo, Türkiye	38.48931	26.96261	\N	\N	f	2
806	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761985267/xruhzuet8ldcrzas4afn.jpg	2025-10-30 11:19:00	Agora of Smyrna, Konak, Izmir, Türkiye	38.41883	27.13876	\N	\N	f	2
807	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761985338/sp4sdzkczo32g6v38xnp.jpg	2025-10-30 11:21:00	Agora of Smyrna, Izmir, Türkiye	38.4189	27.13905	\N	\N	f	2
808	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761985402/hvdqafrwv1l0mzrtwodl.jpg	2025-10-30 11:22:00	Agora of Smyrna, Izmir, Türkiye	38.41858	27.13883	\N	\N	f	2
809	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761985453/wsaxzd68ukgedna4sea2.jpg	2025-10-30 11:23:00	Agora of Smyrna, Izmir, Türkiye	38.41861	27.13914	\N	\N	f	2
810	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761985639/ar9odqwv8n7oahwcxbjv.jpg	2025-10-30 11:27:00	Izmir, Türkiye	38.4162	27.14278	\N	\N	f	2
811	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761985720/kysrpv1v0xyjgjq3mg2e.jpg	2025-10-30 11:28:00	Izmir, Türkiye	38.41611	27.14241	\N	\N	f	2
812	https://res.cloudinary.com/dkaff7r7k/image/upload/v1761985874/igdewyiteren7u2cjnix.jpg	2025-10-30 11:29:00	Kadifekale Castle, Izmir, Türkiye	38.41464	27.14566	\N	\N	f	2
...
824	https://res.cloudinary.com/dkaff7r7k/image/upload/v1766393323/ycp2ctrxgh0nax8yhjim.jpg	2025-09-09 12:42:00	San Jose, Costa Rica	9.93584	-84.10627	Parmotrema perlatum	1	f	1
...
846	https://res.cloudinary.com/dkaff7r7k/image/upload/v1781526909/a2tvmtubeiy8qtuyfanv.jpg	2025-11-15 14:37:00	Strada Cașoca, Buzău	45.151961	26.838894	Parmelia sulcata	7	f	34
847	https://res.cloudinary.com/dkaff7r7k/image/upload/v1781527840/hfatg3tsda9lpqixnmjp.jpg	2025-11-15 14:39:00	Dorobanți Street, Buzău	45151131	26.839511	Parmelia sulcata + Peltigera canina + Xanthoria parietina	6	f	34
...
856	https://res.cloudinary.com/dkaff7r7k/image/upload/v1782217445/uf45l4dpxgxxhh3xljws.jpg	2026-06-23 23:41:00	Jabenita, judetul Mureș	46.484	24.4835	Usnea subfloridana	2	f	86
...
858	https://res.cloudinary.com/dkaff7r7k/image/upload/v1782653950/ajkpzz46q3h1ktrudx0v.jpg	2026-06-27 17:26:00	Hagala botanical Gardens nuweraelliya srilanka	6.925656	80.822017	\N	\N	f	89
859	https://res.cloudinary.com/dkaff7r7k/image/upload/v1782654035/aqsgozkhuplzpzv69pm8.jpg	2026-06-27 17:22:00	Hagala botanical Gardens nuweraelliya srilanka	6.925656	80.822017	\N	\N	f	89
...
861	https://res.cloudinary.com/dkaff7r7k/image/upload/v1782654147/uizh8gpdlubxswavsft7.jpg	2026-06-27 17:12:00	Hagala botanical Gardens nuweraelliya srilanka	6.925656	80.822017	\N	\N	f	89
862	https://res.cloudinary.com/dkaff7r7k/image/upload/v1782655917/tmhvp4nnzqtbb2bqhgut.jpg	2026-06-28 16:32:00	Parcu Tatarasi, Suceava	47.637216	26.261567	Xanthoria parietina + Phaeophyscia orbicularis	9	f	91
864	https://res.cloudinary.com/dkaff7r7k/image/upload/v1782656297/wiylq7clld5wlhudo3lq.jpg	2026-06-28 15:50:00	Parcul Tătărași	47.637013	26.261479	Xanthoria parietina	4	f	90
...
865	https://res.cloudinary.com/dkaff7r7k/image/upload/v1782656596/yee1wz8celdz28uvjcr3.jpg	2026-06-28 16:36:00	Parcul Tătărași, Suceava	47.636808	26.261489	Phaeophyscia orbicularis + Xanthoria parietina	9	f	55
866	https://res.cloudinary.com/dkaff7r7k/image/upload/v1782656836/kbefsspttaamekq31lh9.jpg	2026-06-28 15:50:00	Parcul Tătărași	47.636949	26.261326	Xanthoria parietina & Physcia spp	8	f	90
868	https://res.cloudinary.com/dkaff7r7k/image/upload/v1782658979/vduibbc0387kcbpbtvn8.jpg	2026-06-28 16:43:00	Parcu Tatarasi, Suceava	47.638727	26.263978	Xanthoria parietina + Hypogymnia physodes	7	f	91
867	https://res.cloudinary.com/dkaff7r7k/image/upload/v1782658808/qyp1ew2vwloun3zuocxw.jpg	2026-06-28 17:41:00	Parcu Tatarasi, Suceava	47.63521	26.26363	Xanthoria parietina	10	t	91
863	https://res.cloudinary.com/dkaff7r7k/image/upload/v1782656286/aumoyw8iuzfszoq9bu1f.jpg	2026-06-28 16:33:00	Parcul Tătărași, Suceava	47.637114	26.261516	Xanthoria parietina + Phaeophyscia orbicularis	9	f	91
869	https://res.cloudinary.com/dkaff7r7k/image/upload/v1783063543/bigpqgoekdtwvlalqsm7.jpg	2026-06-24 12:50:00	বিএডিসি কঃগ্রোঃ জোন অফিস, Tubewell Par Mor, Jamalpur, Bangladesh	24.88576305718807	89.93991057754053	-	\N	f	83
870	https://res.cloudinary.com/dkaff7r7k/image/upload/v1783065898/mocgfzxgakw0yyuau1xg.jpg	2026-06-28 16:00:00	BGB Officers' Mess, Jamalpur, Bangladesh	24.937002985932796	89.92427934948735	\N	\N	f	83
...
887	https://res.cloudinary.com/dkaff7r7k/image/upload/v1783517260/uekubi700cmo9bi8dpy8.jpg	2026-06-28 16:03:00	Bonpara, Jamalpur, Bangladesh	24.930106	89.931311	\N	\N	f	83
888	https://res.cloudinary.com/dkaff7r7k/image/upload/v1783517314/icyu6uqnwwxjvqwotg3s.jpg	2026-06-28 16:05:00	Bonpara, Jamalpur, Bangladesh	24.930106	89.931311	\N	\N	f	83
889	https://res.cloudinary.com/dkaff7r7k/image/upload/v1783517349/ps4u7aezdv2ac5e65td0.jpg	2026-06-28 16:07:00	Bonpara, Jamalpur, Bangladesh	24.930106	89.931311	\N	\N	f	83
890	https://res.cloudinary.com/dkaff7r7k/image/upload/v1783517404/jus18galuje2oqk987fj.jpg	2026-06-28 16:01:00	Bonpara, Jamalpur, Bangladesh	24.930106	89.931311	\N	\N	f	83
\.


--
-- Data for Name: user; Type: TABLE DATA; Schema: public; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: schema_migrations; Type: TABLE DATA; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: subscription; Type: TABLE DATA; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: buckets; Type: TABLE DATA; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: migrations; Type: TABLE DATA; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: objects; Type: TABLE DATA; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: s3_multipart_uploads; Type: TABLE DATA; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Data for Name: s3_multipart_uploads_parts; Type: TABLE DATA; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: refresh_tokens_id_seq; Type: SEQUENCE SET; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: observation_id_seq; Type: SEQUENCE SET; Schema: public; Owner: lichenary_db_pciw_user
--

SELECT pg_catalog.setval('public.observation_id_seq', 890, true);


--
-- Name: user_id_seq; Type: SEQUENCE SET; Schema: public; Owner: lichenary_db_pciw_user
--
...
--
-- Name: subscription_id_seq; Type: SEQUENCE SET; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_amr_claims amr_id_pk; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: audit_log_entries audit_log_entries_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: flow_state flow_state_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: identities identities_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: identities identities_provider_id_provider_unique; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: instances instances_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_amr_claims mfa_amr_claims_session_id_authentication_method_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_challenges mfa_challenges_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_factors mfa_factors_last_challenged_at_key; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_factors mfa_factors_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: oauth_clients oauth_clients_client_id_key; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: oauth_clients oauth_clients_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: one_time_tokens one_time_tokens_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: refresh_tokens refresh_tokens_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: refresh_tokens refresh_tokens_token_unique; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: saml_providers saml_providers_entity_id_key; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: saml_providers saml_providers_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: saml_relay_states saml_relay_states_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: schema_migrations schema_migrations_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sessions sessions_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sso_domains sso_domains_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sso_providers sso_providers_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: users users_phone_key; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: observation observation_pkey; Type: CONSTRAINT; Schema: public; Owner: lichenary_db_pciw_user
--
...
--
-- Name: user user_email_key; Type: CONSTRAINT; Schema: public; Owner: lichenary_db_pciw_user
--
...
--
-- Name: user user_pkey; Type: CONSTRAINT; Schema: public; Owner: lichenary_db_pciw_user
--
...
--
-- Name: user user_username_key; Type: CONSTRAINT; Schema: public; Owner: lichenary_db_pciw_user
--
...
--
-- Name: messages messages_pkey; Type: CONSTRAINT; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
--
-- Name: subscription pk_subscription; Type: CONSTRAINT; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
--
-- Name: schema_migrations schema_migrations_pkey; Type: CONSTRAINT; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
--
-- Name: buckets buckets_pkey; Type: CONSTRAINT; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: migrations migrations_name_key; Type: CONSTRAINT; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: migrations migrations_pkey; Type: CONSTRAINT; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: objects objects_pkey; Type: CONSTRAINT; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: s3_multipart_uploads_parts s3_multipart_uploads_parts_pkey; Type: CONSTRAINT; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: s3_multipart_uploads s3_multipart_uploads_pkey; Type: CONSTRAINT; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: audit_logs_instance_id_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: confirmation_token_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: email_change_token_current_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: email_change_token_new_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: factor_id_created_at_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: flow_state_created_at_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: identities_email_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: INDEX identities_email_idx; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: identities_user_id_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: idx_auth_code; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: idx_user_id_auth_method; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_challenge_created_at_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_factors_user_friendly_name_unique; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_factors_user_id_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: oauth_clients_client_id_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: oauth_clients_deleted_at_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: one_time_tokens_relates_to_hash_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: one_time_tokens_token_hash_hash_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: one_time_tokens_user_id_token_type_key; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: reauthentication_token_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: recovery_token_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: refresh_tokens_instance_id_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: refresh_tokens_instance_id_user_id_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: refresh_tokens_parent_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: refresh_tokens_session_id_revoked_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: refresh_tokens_updated_at_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: saml_providers_sso_provider_id_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: saml_relay_states_created_at_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: saml_relay_states_for_email_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: saml_relay_states_sso_provider_id_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sessions_not_after_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sessions_user_id_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sso_domains_domain_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sso_domains_sso_provider_id_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sso_providers_resource_id_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sso_providers_resource_id_pattern_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: unique_phone_factor_per_user; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: user_id_created_at_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: users_email_partial_key; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: INDEX users_email_partial_key; Type: COMMENT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: users_instance_id_email_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: users_instance_id_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: users_is_anonymous_idx; Type: INDEX; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: ix_realtime_subscription_entity; Type: INDEX; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
--
-- Name: subscription_subscription_id_entity_filters_key; Type: INDEX; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
--
-- Name: bname; Type: INDEX; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: bucketid_objname; Type: INDEX; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: idx_multipart_uploads_list; Type: INDEX; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: idx_objects_bucket_id_name; Type: INDEX; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: name_prefix_search; Type: INDEX; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: subscription tr_check_filters; Type: TRIGGER; Schema: realtime; Owner: lichenary_db_pciw_user
--
...
--
-- Name: objects update_objects_updated_at; Type: TRIGGER; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: identities identities_user_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_amr_claims mfa_amr_claims_session_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_challenges mfa_challenges_auth_factor_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: mfa_factors mfa_factors_user_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: one_time_tokens one_time_tokens_user_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: refresh_tokens refresh_tokens_session_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: saml_providers saml_providers_sso_provider_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: saml_relay_states saml_relay_states_flow_state_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: saml_relay_states saml_relay_states_sso_provider_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sessions sessions_user_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: sso_domains sso_domains_sso_provider_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: lichenary_db_pciw_user
--
...
--
-- Name: observation observation_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: lichenary_db_pciw_user
--
...
--
-- Name: objects objects_bucketId_fkey; Type: FK CONSTRAINT; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: s3_multipart_uploads s3_multipart_uploads_bucket_id_fkey; Type: FK CONSTRAINT; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: s3_multipart_uploads_parts s3_multipart_uploads_parts_bucket_id_fkey; Type: FK CONSTRAINT; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: s3_multipart_uploads_parts s3_multipart_uploads_parts_upload_id_fkey; Type: FK CONSTRAINT; Schema: storage; Owner: lichenary_db_pciw_user
--
...
--
-- Name: audit_log_entries; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.audit_log_entries ENABLE ROW LEVEL SECURITY;

--
-- Name: flow_state; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.flow_state ENABLE ROW LEVEL SECURITY;

--
-- Name: identities; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.identities ENABLE ROW LEVEL SECURITY;

--
-- Name: instances; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.instances ENABLE ROW LEVEL SECURITY;

--
-- Name: mfa_amr_claims; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.mfa_amr_claims ENABLE ROW LEVEL SECURITY;

--
-- Name: mfa_challenges; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.mfa_challenges ENABLE ROW LEVEL SECURITY;

--
-- Name: mfa_factors; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.mfa_factors ENABLE ROW LEVEL SECURITY;

--
-- Name: one_time_tokens; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.one_time_tokens ENABLE ROW LEVEL SECURITY;

--
-- Name: refresh_tokens; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.refresh_tokens ENABLE ROW LEVEL SECURITY;

--
-- Name: saml_providers; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.saml_providers ENABLE ROW LEVEL SECURITY;

--
-- Name: saml_relay_states; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.saml_relay_states ENABLE ROW LEVEL SECURITY;

--
-- Name: schema_migrations; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.schema_migrations ENABLE ROW LEVEL SECURITY;

--
-- Name: sessions; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.sessions ENABLE ROW LEVEL SECURITY;

--
-- Name: sso_domains; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.sso_domains ENABLE ROW LEVEL SECURITY;

--
-- Name: sso_providers; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.sso_providers ENABLE ROW LEVEL SECURITY;

--
-- Name: users; Type: ROW SECURITY; Schema: auth; Owner: lichenary_db_pciw_user
--

ALTER TABLE auth.users ENABLE ROW LEVEL SECURITY;

--
-- Name: observation; Type: ROW SECURITY; Schema: public; Owner: lichenary_db_pciw_user
--

ALTER TABLE public.observation ENABLE ROW LEVEL SECURITY;

--
-- Name: user; Type: ROW SECURITY; Schema: public; Owner: lichenary_db_pciw_user
--

ALTER TABLE public."user" ENABLE ROW LEVEL SECURITY;

--
-- Name: messages; Type: ROW SECURITY; Schema: realtime; Owner: lichenary_db_pciw_user
--

ALTER TABLE realtime.messages ENABLE ROW LEVEL SECURITY;

--
-- Name: buckets; Type: ROW SECURITY; Schema: storage; Owner: lichenary_db_pciw_user
--

ALTER TABLE storage.buckets ENABLE ROW LEVEL SECURITY;

--
-- Name: migrations; Type: ROW SECURITY; Schema: storage; Owner: lichenary_db_pciw_user
--

ALTER TABLE storage.migrations ENABLE ROW LEVEL SECURITY;

--
-- Name: objects; Type: ROW SECURITY; Schema: storage; Owner: lichenary_db_pciw_user
--

ALTER TABLE storage.objects ENABLE ROW LEVEL SECURITY;

--
-- Name: s3_multipart_uploads; Type: ROW SECURITY; Schema: storage; Owner: lichenary_db_pciw_user
--

ALTER TABLE storage.s3_multipart_uploads ENABLE ROW LEVEL SECURITY;

--
-- Name: s3_multipart_uploads_parts; Type: ROW SECURITY; Schema: storage; Owner: lichenary_db_pciw_user
--

ALTER TABLE storage.s3_multipart_uploads_parts ENABLE ROW LEVEL SECURITY;

--
-- Name: supabase_realtime; Type: PUBLICATION; Schema: -; Owner: lichenary_db_pciw_user
--

CREATE PUBLICATION supabase_realtime WITH (publish = 'insert, update, delete, truncate');


ALTER PUBLICATION supabase_realtime OWNER TO lichenary_db_pciw_user;

--
-- Name: FUNCTION armor(bytea); Type: ACL; Schema: extensions; Owner: postgres
--

GRANT ALL ON FUNCTION extensions.armor(bytea) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.armor(bytea, text[], text[]) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.crypt(text, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.dearmor(text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.decrypt(bytea, bytea, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.decrypt_iv(bytea, bytea, bytea, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.digest(bytea, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.digest(text, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.encrypt(bytea, bytea, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.encrypt_iv(bytea, bytea, bytea, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.fips_mode() TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.gen_random_bytes(integer) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.gen_random_uuid() TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.gen_salt(text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.gen_salt(text, integer) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.hmac(bytea, bytea, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.hmac(text, text, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pg_stat_statements(showtext boolean, OUT userid oid, OUT dbid oid, OUT toplevel boolean, OUT queryid bigint, OUT query text, OUT plans bigint, OUT total_plan_time double precision, OUT min_plan_time double precision, OUT max_plan_time double precision, OUT mean_plan_time double precision, OUT stddev_plan_time double precision, OUT calls bigint, OUT total_exec_time double precision, OUT min_exec_time double precision, OUT max_exec_time double precision, OUT mean_exec_time double precision, OUT stddev_exec_time double precision, OUT rows bigint, OUT shared_blks_hit bigint, OUT shared_blks_read bigint, OUT shared_blks_dirtied bigint, OUT shared_blks_written bigint, OUT local_blks_hit bigint, OUT local_blks_read bigint, OUT local_blks_dirtied bigint, OUT local_blks_written bigint, OUT temp_blks_read bigint, OUT temp_blks_written bigint, OUT shared_blk_read_time double precision, OUT shared_blk_write_time double precision, OUT local_blk_read_time double precision, OUT local_blk_write_time double precision, OUT temp_blk_read_time double precision, OUT temp_blk_write_time double precision, OUT wal_records bigint, OUT wal_fpi bigint, OUT wal_bytes numeric, OUT wal_buffers_full bigint, OUT jit_functions bigint, OUT jit_generation_time double precision, OUT jit_inlining_count bigint, OUT jit_inlining_time double precision, OUT jit_optimization_count bigint, OUT jit_optimization_time double precision, OUT jit_emission_count bigint, OUT jit_emission_time double precision, OUT jit_deform_count bigint, OUT jit_deform_time double precision, OUT parallel_workers_to_launch bigint, OUT parallel_workers_launched bigint, OUT stats_since timestamp with time zone, OUT minmax_stats_since timestamp with time zone) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pg_stat_statements_info(OUT dealloc bigint, OUT stats_reset timestamp with time zone) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_armor_headers(text, OUT key text, OUT value text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_key_id(bytea) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_pub_decrypt(bytea, bytea) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_pub_decrypt(bytea, bytea, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_pub_decrypt(bytea, bytea, text, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_pub_decrypt_bytea(bytea, bytea) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_pub_decrypt_bytea(bytea, bytea, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_pub_decrypt_bytea(bytea, bytea, text, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_pub_encrypt(text, bytea) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_pub_encrypt(text, bytea, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_pub_encrypt_bytea(bytea, bytea) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_pub_encrypt_bytea(bytea, bytea, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_sym_decrypt(bytea, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_sym_decrypt(bytea, text, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_sym_decrypt_bytea(bytea, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_sym_decrypt_bytea(bytea, text, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_sym_encrypt(text, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_sym_encrypt(text, text, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_sym_encrypt_bytea(bytea, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.pgp_sym_encrypt_bytea(bytea, text, text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.uuid_generate_v1() TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.uuid_generate_v1mc() TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.uuid_generate_v3(namespace uuid, name text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.uuid_generate_v4() TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.uuid_generate_v5(namespace uuid, name text) TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.uuid_nil() TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.uuid_ns_dns() TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.uuid_ns_oid() TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.uuid_ns_url() TO lichenary_db_pciw_user;
...
GRANT ALL ON FUNCTION extensions.uuid_ns_x500() TO lichenary_db_pciw_user;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres GRANT ALL ON SEQUENCES TO lichenary_db_pciw_user;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres GRANT ALL ON TYPES TO lichenary_db_pciw_user;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres GRANT ALL ON FUNCTIONS TO lichenary_db_pciw_user;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres GRANT ALL ON TABLES TO lichenary_db_pciw_user;
...
\unrestrict sRnBZ1aQNXDl6NBweT6PLK1c5105CYfX3R6Bd6YIMpk39a82V28O2lkcRxcbVew
