...
def identify_lichen_species(image_bytes, mime_type): 
    ...
    prompt = """ 
Identify the lichen species shown in this photograph. 
 
Look carefully at the lichen itself and identify the most likely 
scientific species based on its visible morphology. 
 
This is a lichen identification task. 
 
Return ONLY the scientific name of the most likely species. 
 
Do not explain your answer. 
Do not describe the photograph. 
Do not mention your reasoning. 
Do not provide a confidence score. 
Do not provide a pollution score. 
Do not write a sentence. 
Do not add punctuation. 
 
Your entire response must contain only the scientific species name. 
 
If the lichen cannot genuinely be identified from the photograph, 
return exactly: 
